	...
	public static void Cadastrar() {
		...
		if (aux == null) {
			...
			estoque.inserir(dado);
				...
				JOptionPane.showMessageDialog(null, "Produto ja existe no sistema");
		}
	}

    public static void ProdutosL(){
        if(estoque.posicao == 0){
            	JOptionPane.showMessageDialog(null, "Ainda nao existem produtos cadastrados");
    ...
    public static void Vender(){
        ...
        if(aux == null){
            ...
            if(qtd > aux.dado.getQuantidade()){
                JOptionPane.showMessageDialog(null, "Esse produto nao tem um validade correta");
            } else{
